...
class Inventory extends CI_Controller
{
    ...
    public function updateInventoryQty()
    {
        ...
        $this->session->set_flashdata('alert_msg', array('success', 'Actualizar inventario de producto', "Inventario actualizado exitosamente para Código de Producto : $pcode"));
