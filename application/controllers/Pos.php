...
class Pos extends CI_Controller
{
    ...
    public function insertSale()
    {
        if (isset($_POST['hold_bill_submit'])) {
            ...
            $this->session->set_flashdata('alert_msg', array('success', 'Añadir factura abierta', 'Agregado exitosamente a la factura abierta.'));
		...
		<?php
                ...
                $this->session->set_flashdata('alert_msg', array('success', 'Añadir nuevo producto', 'Nuevo producto exitosamente agregado.'));
                redirect(base_url().'pos');
            }
        } else {    // Sales;
