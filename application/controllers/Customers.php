...
class Customers extends CI_Controller
{
    ...
    public function deleteCustomer()
    {
        ...
        if ($this->Constant_model->deleteData('customers', $cust_id)) {
            $this->session->set_flashdata('alert_msg', array('success', 'Eliminar cliente', "Cliente eliminado exitosamente : $cust_fn."));
    ...
    public function insertCustomer()
    {
        ...
        if (empty($fullname)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Ingresar Cliente', 'Por favor ingrese el nombre completo del cliente!'));
            ...
            if (!empty($email)) {
                ...
                if (count($ckEmailData) > 0) {
                    $this->session->set_flashdata('alert_msg', array('failure', 'Ingresar cliente', "La dirección de email : $email ¡Ya existe en el sistema! Por favor intente otra dirección de correo electrónico!"));
                    redirect(base_url().'customers/addCustomer');
                    die();
                }
            }
            ...
            if ($this->Constant_model->insertData('customers', $ins_cust_data)) {
                $this->session->set_flashdata('alert_msg', array('success', 'Ingresar cliente', "Cliente agregado exitosamente : $fullname"));
                redirect(base_url().'customers/addCustomer');
            }
        }
    }
    ...
    public function updateCustomer()
    {
        ...
        $this->session->set_flashdata('alert_msg', array('success', 'Actualizar cliente', 'Detalles del cliente correctamente actualizados!'));
    ...
    public function exportCustomer()
    {
        ...
        $objWriter->save('Customer_Report.xls');
