...
class Expenses extends CI_Controller
{
    ...
    public function updateExpenseCategory()
    {
        ...
        if (empty($name)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Actualizar categoría de gastos', 'Por favor ingrese el Nombre de la Categoría de Gastos!'));
            ...
            if ($this->Constant_model->updateData('expense_categories', $upd_data, $id)) {
                $this->session->set_flashdata('alert_msg', array('success', 'Actualizar categoría de gastos', "Nombre de categoría de gastos actualizado correctamente : $name!"));
                redirect(base_url().'expenses/expense_category_edit?id='.$id);
            }
        }
    }
    ...
    public function insertExpenseCategory()
    {
        ...
        if (empty($name)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Añadir categoría de gastos', 'Por favor ingrese el Nombre de la Categoría de Gastos
            !'));
            ...
            if ($this->Constant_model->insertData('expense_categories', $ins_data)) {
                $this->session->set_flashdata('alert_msg', array('success', 'Añadir categoría de gastos', "Agregado exitosamente Nuevo Nombre de Categoría de Gastos  : $name!"));
    ...
    public function deleteExpenses()
    {
        ...
        if (count($expDtaData) == 0) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Eliminar gastos', 'Error al eliminar!'));
            redirect(base_url().'expenses/view');
        } else {
            if ($this->Constant_model->deleteData('expenses', $id)) {
                $this->session->set_flashdata('alert_msg', array('success', 'Eliminar gastos', 'Datos eliminados!'));
                redirect(base_url().'expenses/view');
            }
        }
    }
    ...
    public function updateExpenses()
    {
        ...
        if (!empty($temp_fn)) {
            ...
            if ($_FILES['uploadFile']['size'] > 2097152) {
                $this->session->set_flashdata('alert_msg', array('failure', 'Añadir nuevos gastos', 'El tamaño del archivo de carga debe ser inferior a 2 MB!'));
        ...
        if (empty($number)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Actualizar', 'Por favor ingrese el número!'));
            redirect(base_url().'expenses/editExpenses?id='.$id);
        } elseif (empty($outlet)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Actualizar', 'Por favor, elija los gastos de salida!'));
            redirect(base_url().'expenses/editExpenses?id='.$id);
        } elseif (empty($date)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Actualizar', 'Por favor ingrese la fecha!'));
            redirect(base_url().'expenses/editExpenses?id='.$id);
        } elseif (empty($amount)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Actualizar', 'Por favor ingrese el monto!'));
            redirect(base_url().'expenses/editExpenses?id='.$id);
        } elseif (empty($exp_category)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Actualizar', 'Por favor, seleccione la categoría!'));
            redirect(base_url().'expenses/editExpenses?id='.$id);
        } else {
            $upd_data = array(
            ...
            if ($this->Constant_model->updateData('expenses', $upd_data, $id)) {
                ...
                $this->session->set_flashdata('alert_msg', array('success', 'Actualizar', 'Actualizado exitosamente!'));
                redirect(base_url().'expenses/editExpenses?id='.$id);
            }
        }
    }
    ...
    public function insertNewExpenses()
    {
        ...
        if (!empty($temp_fn)) {
            ...
            if ($_FILES['uploadFile']['size'] > 2097152) {
                $this->session->set_flashdata('alert_msg', array('failure', 'Añadir', 'El tamaño del archivo de carga debe ser inferior a 2 MB!'));
                redirect(base_url().'expenses/addNewExpenses');
        ...
        if (empty($number)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Añadir', 'Ingrese el numero!'));
            redirect(base_url().'expenses/addNewExpenses');
        } elseif (empty($outlet)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Añadir', 'Ingrese la salida!'));
            redirect(base_url().'expenses/addNewExpenses');
        } elseif (empty($date)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Añadir', 'Ingrese la fecha!'));
            redirect(base_url().'expenses/addNewExpenses');
        } elseif (empty($amount)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Añadir', 'Ingrese el monto!'));
            redirect(base_url().'expenses/addNewExpenses');
        } elseif (empty($exp_category)) {
            $this->session->set_flashdata('alert_msg', array('failure', 'Añadir', 'Seleccione la categoría!'));
            redirect(base_url().'expenses/addNewExpenses');
        } else {
            $ins_data = array(
                    'expenses_number' => $number,
            ...
            $this->session->set_flashdata('alert_msg', array('success', 'Añadir', 'Añadido exitosamente!'));
            redirect(base_url().'expenses/addNewExpenses');
        }
    }
