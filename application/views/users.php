					...
					<div class="row">
						<div class="col-md-12">
							...
							<a href="<?=base_url()?>setting/adduser" style="text-decoration: none">
								<button class="btn btn-default" style="padding: 0px 12px;"><i class="icono-plus"></i><?php echo $lang_add_new_user; ?></button>
							</a>
							<?php
                                            ...
                                            if ($status == '0') {
												...
												<td>
													<a href="<?=base_url()?>setting/changePassword?id=<?php echo $id; ?>" style="text-decoration: none; padding: 5px 5px;">
														<button class="btn btn-dark"><?php echo $lang_change_password; ?></button>
													</a>
