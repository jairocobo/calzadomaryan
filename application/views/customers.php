					...
					<div class="row" style="border-bottom: 1px solid #e0dede; padding-bottom: 8px; margin-top: -5px;">
						<div class="col-md-6">
							<a href="<?=base_url()?>customers/addCustomer" style="text-decoration: none;">
								<button type="button" class="btn btn-default" style="padding-top: 2px; padding-bottom: 2px; border: 0px;">
					...
					<form action="<?=base_url()?>customers/searchcustomer" method="get">
						<div class="row" style="margin-top: 10px;">
							...
							<div class="col-md-2">
								<div class="form-group">
									<label>&nbsp;</label><br />
									<button class="btn btn-dark" style="width: 100%;">&nbsp;&nbsp;<?php echo $lang_search; ?>&nbsp;&nbsp;</button>
								</div>
							</div>
						</div>
					</form>
						...
						<div class="col-md-12">
							...
							<div class="table-responsive">
								...
								<a href="<?=base_url()?>customers/edit_customer?cust_id=<?php echo $cust_id; ?>" style="text-decoration: none;">
									<button class="btn btn-dark" style="padding: 4px 12px;">&nbsp;&nbsp;<?php echo $lang_edit; ?>&nbsp;&nbsp;</button>
								</a>
								
								<a href="<?=base_url()?>customers/customer_history?cust_id=<?php echo $cust_id; ?>" style="text-decoration: none; margin-left: 10px;">
									<button class="btn btn-dark" style="padding: 4px 12px;">&nbsp;&nbsp;<?php echo $lang_sales_history; ?>&nbsp;&nbsp;</button>
								</a>
													</td>
												</tr>
									<?php
