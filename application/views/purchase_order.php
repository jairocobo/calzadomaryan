					...
					<div class="row">
						<div class="col-md-12">
							...
							<a href="<?=base_url()?>purchase_order/create_purchase_order" style="text-decoration: none">
								<button class="btn btn-default" style="padding: 0px 12px;"><i class="icono-plus"></i>
				...
				<?php
                    if ($status_id == '1') {
						...
						<a href="<?=base_url()?>purchase_order/editpo?id=<?php echo $id; ?>" style="text-decoration: none; margin-left: 5px;">
							<button class="btn btn-dark" style="padding: 5px 12px;">&nbsp;&nbsp;<?php echo $lang_edit; ?>&nbsp;&nbsp;</button>
						</a>
						
						<?php
                            if ($user_role == '1') {
                                ?>
						<a href="<?=base_url()?>purchase_order/deletePO?id=<?php echo $id; ?>&po_numb=<?php echo $po_numb; ?>" style="text-decoration: none; margin-left: 10px;" onclick="return confirm('Esta seguro de eliminar : <?php echo $po_numb; ?>?')">
						...
						<?php
                            if ($status_id == '2') {
								...
								<a href="<?=base_url()?>purchase_order/receivepo?id=<?php echo $id; ?>" style="text-decoration: none; margin-left: 5px;">
									<button class="btn btn-dark" style="padding: 5px 12px;">&nbsp;&nbsp;<?php echo $lang_receive; ?>&nbsp;&nbsp;</button>
								</a>
						<?php

                            } ?>
						<a href="<?=base_url()?>purchase_order/viewpo?id=<?php echo $id; ?>" style="text-decoration: none; margin-left: 5px;">
							<button class="btn btn-dark" style="padding: 5px 12px;">&nbsp;&nbsp;<?php echo $lang_view; ?>&nbsp;&nbsp;</button>
						</a>
