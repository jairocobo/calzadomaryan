			...
			<td>
				<?php
                    if ($gift_status == '0') {
                        if ($user_role == '1') {
                            ?>
<a href="<?=base_url()?>gift_card/deletegiftcard?id=<?php echo $gift_id; ?>" style="text-decoration: none; margin-left: 5px;" title="Delete" onclick="return confirm('Esta seguro de eliminar : <?php echo $gift_numb; ?>?')">
