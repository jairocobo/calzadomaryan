				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12" style="text-align: right;">
							<form action="<?=base_url()?>products/deleteProduct" method="post" onsubmit="return confirm('Esta seguro de eliminar?')">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="fileUpload btn btn-dark" style="padding: 9px 12px;">
