					...
					<form action="<?=base_url()?>auth/login" method="post">
						<fieldset>
							<div class="form-group">
								<input type="email" name="email" class="form-control" autofocus autocomplete="off" required placeholder="Ingrese el correo" />
							</div>
							<div class="form-group">
								<input type="password" name="password" class="form-control" placeholder="Ingrese la clave" required autocomplete="off" />
							</div>
							<br />
							<center>
								<button class="btn btn-dark" name="sp_login">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INGRESAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
							</center>
