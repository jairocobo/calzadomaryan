						...
						<div class="row" style="margin-top: 10px;">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<button class="btn btn-dark" style="width: 100%; height: 35px;">&nbsp;&nbsp;<?php echo $lang_search; ?>&nbsp;&nbsp;</button>
								</div>
							</div>
						</div>
					</form>
						...
						<div class="table-responsive">
							<table class="table">
                    			...
                    			<a href="<?=base_url()?>debit/make_payment?id=<?php echo $id; ?>" style="text-decoration: none;">
									<button class="btn btn-dark" style="padding: 4px 12px;">&nbsp;&nbsp;<?php echo $lang_make_payment; ?>&nbsp;&nbsp;</button>
								</a>
	                                			</td>
                                			</tr>
                                <?php 
