...
<div class="row" style="margin-bottom: 5px;">
	<div class="col-md-12">
		<a class="btn btn-default" href="#addCustomerPopUp" data-toggle="modal" style="border: 0px; width: 100%; padding: 0px 12px;">
...
<div class="row">
	<div class="col-md-12">
		<input type="text" class="form-control" id="pcodeBarcode" style="border: 1px solid #373942;" placeholder="<?php echo "ESCANEAR CODIGO DE BARRAS"; ?>" />
	</div>
</div>
	...
	<div id="log"></div>
							...
							<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-4" style="margin-top: 8px;">
										<a class="btn btn-dark" href="#timepicker4Modal" data-toggle="modal" style="background-color: #3fb618; float: right; font-weight: bold; color: #FFF; border: 0px; padding-top: 10px; padding-bottom: 10px; width: 100%;">
...
<!--
	<div class="col-md-3" style="padding-top: 10px;">
		<a class="btn btn-dark" href="#addProductPopUp" data-toggle="modal" style="border: 0px; width: 100%; padding: 3px 12px; background-color: #b205c2;">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF;">
					...
					<div class="row" style="margin-top: 10px;">
						<div class="col-md-6"><b>Precio de venta</b></div>
						<div class="col-md-6">
					...
					<div class="modal-footer" style="margin-top: 10px;">
						<input type="submit" name="add_prod_submit" id="add_prod_submit" value="Add New Product" class="btn btn-dark" style="background-color: #3fb618; color: #FFF; border: 0px; padding: 5px 25px; float: right;" />
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF; border-radius: 12px;">
					...
					<div class="row">
						<div class="col-md-12" style="text-align: center; font-size: 25px; padding-top: 20px; padding-bottom: 20px; color: #c72a25;">
						No se puede reducir la cantidad a menos de 1 
							<br />
							Si no lo desea, elimínelo haciendo clic en el signo de x.
						</div>
					</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF;">
					...
					<div class="modal-footer" style="margin-top: 10px;">
						<div name="pop_add_cust_submit" id="pop_add_cust_submit" value="Add Customer" class="btn btn-dark" style="background-color: #3fb618; color: #FFF; border: 0px; padding: 5px 25px; float: right;"><?php echo $lang_add_customer; ?></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF;">
					...
					<div class="modal-footer" style="margin-top: 10px;">
						<input type="submit" name="hold_bill_submit" id="hold_bill_submit" value="<?php echo $lang_submit; ?>" class="btn btn-dark" style="background-color: #3fb618; color: #FFF; border: 0px; padding: 5px 25px; float: right;" />
					</div>
				</div>
			</div>
		</div>
        ...
        $("#card_numb").on("keyup", function(event) {
	        ...
	        if(card_numb.length == 0) {
				...
				<div class="modal-footer" style="margin-top: 0px;">
					<input type="submit" value="<?php echo $lang_submit; ?>" class="btn btn-dark" id="submit_btn" style="background-color: #3fb618; color: #FFF; border: 0px; padding: 5px 25px; float: right; display: none;" />
				</div>
			</div>
		</div>
	</div>
